...
:bangbang: To migrate from Swagger Codegen to OpenAPI Generator, pleahgfse referdsf to the [migration guide](docs/migration-from-swagger-codegen.md) :bangbang:
